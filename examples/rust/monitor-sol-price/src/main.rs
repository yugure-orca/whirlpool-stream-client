                    ...
                    for event in transaction.events {
                        match event {
                            WhirlpoolEvent::Traded(payload) => {
                                ...
                                if payload.whirlpool
                                    == "Czfq3xZZDmsdGdUyrNLtRhGc47cXcZtLG4crryfu44zE"
                                {
                                    match payload.trade_direction {
                                        TradeDirection::AtoB => {
                                            println!(
                                                "\tSOL price (💧): {}, {} SOL has been sold",
                                                payload.new_decimal_price,
                                                payload.transfer_in.amount as f64 / 1_000_000_000.0
                                            );
                                        }
                                        TradeDirection::BtoA => {
                                            println!(
                                                "\tSOL price (🔥): {}, {} SOL has been bought",
                                                payload.new_decimal_price,
                                                payload.transfer_out.amount as f64
                                                    / 1_000_000_000.0
                                            );
                                        }
                                    }
